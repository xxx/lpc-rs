...
unknown ID or an ID belonging to `request_system_reload`. Only the requesting
object may inspect it; another requester raises a permission error.
...
jobs across recompilation and system reload are retained, along with pending jobs. IDs from aborted transactions
