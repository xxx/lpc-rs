...
pub fn check_binary_operation_types(
    ...
    match node.op {
        ...
        BinaryOperation::EqEq | BinaryOperation::NotEq => Ok(()),
...
mod tests {
    ...
    mod check_binary_operation_tests {
        ...
        fn test_and() {
            ...
            assert!(array_array_literals(BinaryOperation::And, &context).is_ok());
            ...
            assert!(array_array_vars(BinaryOperation::And, &context).is_ok());
