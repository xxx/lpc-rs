...
pub trait TreeWalker {
    ...
    fn visit_program(&mut self, node: &ProgramNode) -> Result<(), LPCError> where Self: Sized {
    ...
    fn visit_call(&mut self, node: &CallNode) -> Result<(), LPCError> where Self: Sized {
    ...
    fn visit_int(&mut self, _node: &IntNode)  -> Result<(), LPCError> { Ok(()) }

    /// Visit a string (literal) node
    fn visit_string(&mut self, _node: &StringNode) -> Result<(), LPCError> { Ok(()) }

    /// Visit a binary operation node
    fn visit_binary_op(&mut self, node: &BinaryOpNode) -> Result<(), LPCError> where Self: Sized {
        node.l.visit(self)?;
        node.r.visit(self)?;
    ...
    fn visit_function_def(&mut self, node: &FunctionDefNode) -> Result<(), LPCError> where Self: Sized {
    ...
    fn visit_return(&mut self, node: &ReturnNode) -> Result<(), LPCError> where Self: Sized {
    ...
    fn visit_decl(&mut self, node: &DeclNode) -> Result<(), LPCError> where Self: Sized {
    ...
    fn visit_var_init(&mut self, node: &VarInitNode) -> Result<(), LPCError> where Self: Sized {
    ...
    fn visit_var(&mut self, _node: &VarNode) -> Result<(), LPCError>  where Self: Sized {
        Ok(())
    }
    ...
    fn visit_array(&mut self, node: &ArrayNode) -> Result<(), LPCError>
        where Self: Sized
    {
