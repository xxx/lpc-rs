...
pub struct CodegenWalker {
    // /// Stack of [`Instruction`]s, one for the global init, and one per function,
    // instruction_vecs: Vec<Vec<Instruction>>,
    //
    // /// The [`Span`]s corresponding to the instructions in `instruction_vecs`
    // debug_span_vecs: Vec<Vec<Option<Span>>>,
